...
import { BookOpen, CreditCard, User, Users, FileText, Calendar, GraduationCap, Library, MapPin, Briefcase, Award, MessageSquare, Clock, Download, Upload, TrendingUp, Bell, Star, Target, Zap, Trophy } from 'lucide-react';
  ...
  const menuItems = [
    ...
    },
    {
      ...
      subItems: [
        ...
        { id: 'academics', label: 'Grades & Transcripts' }
      ]
    },
    {
      id: 'services',
    ...
    >
      ...
      <TabsContent value="academics" className="p-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Grades, transcripts, and academic history</CardDescription>
          </CardHeader>
          <CardContent>
            <p className="text-muted-foreground text-center py-8">Academic records coming soon</p>
          </CardContent>
        </Card>
      </TabsContent>
      ...
      <TabsContent value="library" className="p-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Access digital resources and library tools</CardDescription>
          </CardHeader>
          <CardContent>
            <p className="text-muted-foreground text-center py-8">Library services coming soon</p>
          </CardContent>
        </Card>
      </TabsContent>
      ...
      <TabsContent value="career" className="p-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Career guidance and job placement support</CardDescription>
          </CardHeader>
          <CardContent>
            <p className="text-muted-foreground text-center py-8">Career services coming soon</p>
          </CardContent>
        </Card>
      </TabsContent>

      <TabsContent value="campus" className="p-6">
        <Card>
          <CardHeader>
            <CardTitle>Campus Life</CardTitle>
            <CardDescription>Events, activities, and campus resources</CardDescription>
          </CardHeader>
          <CardContent>
            <p className="text-muted-foreground text-center py-8">Campus life information coming soon</p>
          </CardContent>
        </Card>
      </TabsContent>
      ...
      <TabsContent value="profile" className="p-6">
        <Card>
          ...
          <CardContent>
            <p className="text-muted-foreground text-center py-8">Profile management coming soon</p>
          </CardContent>
        </Card>
      </TabsContent>
